...
module.exports = function transform(el, context) {
    ...
    if (base64SrcExpression.type === 'Literal') {
        ...
        */
        ...
        if(path.isAbsolute(base64SrcExpression.value)){
            const appDir = path.resolve(__dirname, '../..');
            imagePath = path.normalize(appDir + base64SrcExpression.value);
        }else{
            const templateDir = context.dirname;
            imagePath = path.resolve(templateDir, base64SrcExpression.value);
        }
