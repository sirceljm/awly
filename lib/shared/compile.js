...
function makeExecutablePageLambdaEdge(compileIntoDir, opt = {}){
    return new Promise(function(resolve, reject){
        fs.writeFile(path.resolve(compileIntoDir, "./index.js"),
            // fs.readFileSync('./helpers/page/lambda-edge/graphql-prepend.js', 'utf8') +
            require(path.resolve(awlyCliDir, "helpers/page/lambda-edge/lambda-prepend-no-gzip.js"))(opt.gzip === false ? false : true) +
