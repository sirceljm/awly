...
function serverStart(projectConfig, options){
    ...
    require(path.resolve(awlyCliDir, "./node_modules/" + markojsModulesPath + "/node-require")).install();
    ...
    const markoInfo = require(path.resolve(awlyCliDir, "./node_modules/" + markojsModulesPath + "/package.json"));
    const markoExpress = require(path.resolve(awlyCliDir, "./node_modules/" + markojsModulesPath + "/express"));
    const markoHotReload = require(path.resolve(awlyCliDir, "./node_modules/" + markojsModulesPath + "/hot-reload"));

    if(hotReload){
        markoHotReload.enable({ silent: true });
    }

    const lasso = require(path.resolve(awlyCliDir, "./node_modules/" + awlyModulesPath + "/lasso"));
    ...
    const dynamoDBAdminGUIRouter = require(path.resolve(awlyCliDir, "./node_modules/@awly/dynamodb-admin/router.js"));
    ...
    app.use(require(path.resolve(awlyCliDir, "./node_modules/" + awlyModulesPath + "/lasso/middleware")).serveStatic());
